    ...
    public static final RegistryEntry<ArmorMaterial> FLUORITE_ARMOR_MATERIAL = registerArmorMaterial("fluorite",
            () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
                ...
                map.put(ArmorItem.Type.BODY, 4);
                    ...
                    List.of(new ArmorMaterial.Layer(Identifier.of(KaupenCourseV2.MOD_ID, "fluorite"))), 0, 0));

    public static RegistryEntry<ArmorMaterial> registerArmorMaterial(String name, Supplier<ArmorMaterial> material) {
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(KaupenCourseV2.MOD_ID, name), material.get());
    }
}
